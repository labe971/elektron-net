 ...
 *  A CTxDestination is the internal data type encoded in an Elektron Net address
 */
...
/**
 * Generate an Elektron Net scriptPubKey for the given CTxDestination. Returns a P2PKH
