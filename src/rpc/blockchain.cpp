...
static RPCMethod waitfornewblock()
{
    return RPCMethod{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (elektron-cli -rpcclienttimeout=0)",
                {
            ...
            {RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
                {
                    ...
                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                    {
                        ...
                        {RPCResult::Type::STR, "address", /*optional=*/true, "The Elektron Net address (only if a well-defined address exists)"},
...
static RPCMethod getblockstats()
{
    return RPCMethod{
        "getblockstats",
        "Compute per block statistics for a given window. All amounts are in Lepton.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", /*optional=*/true, "Average feerate (in Lepton per virtual byte)"},
                {RPCResult::Type::NUM, "avgtxsize", /*optional=*/true, "Average transaction size"},
                {RPCResult::Type::STR_HEX, "blockhash", /*optional=*/true, "The block hash (to check for potential reorgs)"},
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", /*optional=*/true, "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in Lepton per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", /*optional=*/true, "Maximum feerate (in Lepton per virtual byte)"},
                {RPCResult::Type::NUM, "maxtxsize", /*optional=*/true, "Maximum transaction size"},
                {RPCResult::Type::NUM, "medianfee", /*optional=*/true, "Truncated median fee in the block"},
                {RPCResult::Type::NUM, "mediantime", /*optional=*/true, "The block median time past"},
                {RPCResult::Type::NUM, "mediantxsize", /*optional=*/true, "Truncated median transaction size"},
                {RPCResult::Type::NUM, "minfee", /*optional=*/true, "Minimum fee in the block"},
                {RPCResult::Type::NUM, "minfeerate", /*optional=*/true, "Minimum feerate (in Lepton per virtual byte)"},
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            // New feerate uses Lepton per virtual byte instead of per serialized byte
    ...
    ret_all.pushKV("avgfeerate", total_weight ? (totalfee * WITNESS_SCALE_FACTOR) / total_weight : 0); // Unit: lep/vbyte
...
static RPCMethod scanblocks()
{
    return RPCMethod{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (elektron-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCMethod getdescriptoractivity()
{
    return RPCMethod{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (elektron-cli -rpcclienttimeout=0)",
        {
...
static RPCMethod dumptxoutset()
{
    return RPCMethod{
        ...
        "For deep rollbacks, make sure to use no RPC timeout (elektron-cli -rpcclienttimeout=0) as it may take several minutes.",
        {
...
static RPCMethod loadtxoutset()
{
    return RPCMethod{
        ...
        "The result is a usable elektrond instance that is current with the network tip in a "
