...
static RPCMethod validateaddress()
{
    return RPCMethod{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Elektron Net address to validate"},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::BOOL, "isvalid", "If the address is valid or not"},
                {RPCResult::Type::STR, "address", /*optional=*/true, "The Elektron Net address validated"},
