...
static const CAmount DEFAULT_CONSOLIDATE_FEERATE{10000}; // 10 lep/vbyte
/**
...
//! Discourage users to set fees higher than this amount (in Leptons) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in Leptons)
...
public:
    ...
    /** Absolute maximum transaction fee (in Leptons) used by default for the wallet */
